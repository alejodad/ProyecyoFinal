...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
  ...
  <div class="collapse navbar-collapse navbar-ex1-collapse">
    <ul class="nav navbar-nav">
      ...
      <li class="active"><a href="#">Registro Mensajeros</a></li>      
    </ul>
  </div>
</nav>
<body>
    <form id="form1" runat="server">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="txtEdad" CssClass="form-control" runat="server" placeholder="Ejempl: 22" TextMode="Number"/>  
                    </div>
                    <div class="form-group">
            ...
            <asp:GridView runat="server" ID="datosClientes" AutoGenerateColumns="false" CssClass="table table-hover" GridLines="None" OnRowCommand="datosClientes_RowCommand">  
                <Columns>  
                    ...
                    <asp:ButtonField CommandName="Editar" Text="Editar" ControlStyle-CssClass="btn btn-primary"/>     
